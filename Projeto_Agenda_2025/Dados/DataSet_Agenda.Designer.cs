...
namespace Projeto_Agenda_2025.Dados {
    ...
    public partial class DataSet_Agenda : global::System.Data.DataSet {
        ...
        public partial class PessoaDataTable : global::System.Data.TypedTableBase<PessoaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PessoaRow AddPessoaRow(string Nome, string Endereco, string Cidade, string Telefone, string Email, System.DateTime DataNascimento) {
...
namespace Projeto_Agenda_2025.Dados.DataSet_AgendaTableAdapters {
    ...
    public partial class PessoaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Pessoa] WHERE (([id] = @Original_id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Endereco = 1 AND [Endereco] IS NULL) OR ([Endereco] = @Original_Endereco)) AND ((@IsNull_Cidade = 1 AND [Cidade] IS NULL) OR ([Cidade] = @Original_Cidade)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_DataNascimento = 1 AND [DataNascimento] IS NULL) OR ([DataNascimento] = @Original_DataNascimento)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Pessoa] ([Nome], [Endereco], [Cidade], [Telefone], [Email], [DataNascimento]) VALUES (@Nome, @Endereco, @Cidade, @Telefone, @Email, @DataNascimento);
SELECT id, Nome, Endereco, Cidade, Telefone, Email, DataNascimento FROM Pessoa WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Pessoa] SET [Nome] = @Nome, [Endereco] = @Endereco, [Cidade] = @Cidade, [Telefone] = @Telefone, [Email] = @Email, [DataNascimento] = @DataNascimento WHERE (([id] = @Original_id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Endereco = 1 AND [Endereco] IS NULL) OR ([Endereco] = @Original_Endereco)) AND ((@IsNull_Cidade = 1 AND [Cidade] IS NULL) OR ([Cidade] = @Original_Cidade)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_DataNascimento = 1 AND [DataNascimento] IS NULL) OR ([DataNascimento] = @Original_DataNascimento)));
SELECT id, Nome, Endereco, Cidade, Telefone, Email, DataNascimento FROM Pessoa WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Projeto_Agenda_2025.Properties.Settings.Default.db_241075ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Nome, Endereco, Cidade, Telefone, Email, DataNascimento FROM dbo.Pesso" +
                "a";
        ...
        public virtual int Delete(int Original_id, string Original_Nome, string Original_Endereco, string Original_Cidade, string Original_Telefone, string Original_Email, global::System.Nullable<global::System.DateTime> Original_DataNascimento) {
        ...
        public virtual int Insert(string Nome, string Endereco, string Cidade, string Telefone, string Email, global::System.Nullable<global::System.DateTime> DataNascimento) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string Endereco, string Cidade, string Telefone, string Email, global::System.Nullable<global::System.DateTime> DataNascimento, int Original_id, string Original_Nome, string Original_Endereco, string Original_Cidade, string Original_Telefone, string Original_Email, global::System.Nullable<global::System.DateTime> Original_DataNascimento, int id) {
            if ((Nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Endereco, string Cidade, string Telefone, string Email, global::System.Nullable<global::System.DateTime> DataNascimento, int Original_id, string Original_Nome, string Original_Endereco, string Original_Cidade, string Original_Telefone, string Original_Email, global::System.Nullable<global::System.DateTime> Original_DataNascimento) {
            return this.Update(Nome, Endereco, Cidade, Telefone, Email, DataNascimento, Original_id, Original_Nome, Original_Endereco, Original_Cidade, Original_Telefone, Original_Email, Original_DataNascimento, Original_id);
        }
    }
